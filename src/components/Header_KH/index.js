...
import styles from "./Header_KH.module.scss";
        ...
        <header className={cx('wrapper')}>
            ...
            <Link className={cx('link')} to="/"><span className={cx('navbar1__logo')}>LOGO</span></Link>
                ...
                <div className={cx('navbar1__wrap')}>
                    ...
                    <Link className={cx('link')} to="/ProfileIndividiual">
                        <div className={cx('navbar1__account')}>
                            <img className={cx('navbar1__account-img')} src="https://taimienphi.vn/tmp/cf/aut/anh-gai-xinh-1.jpg"/>
                        </div>
                    </Link>
